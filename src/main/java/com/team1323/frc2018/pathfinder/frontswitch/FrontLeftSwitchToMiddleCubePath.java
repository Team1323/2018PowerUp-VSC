...
public class FrontLeftSwitchToMiddleCubePath extends PathfinderPath{
	...
	public FrontLeftSwitchToMiddleCubePath(){
		super.points = new Waypoint[]{
			new Waypoint(Constants.kLeftSwitchCloseCorner.x() - Constants.kRobotHalfLength - 1.4, Constants.kLeftSwitchCloseCorner.y() + Constants.kRobotHalfWidth + 0.6, Pathfinder.d2r(180)),
			...
			new Waypoint(Constants.kLeftSwitchCloseCorner.x() - (2*Constants.kCubeWidth) - 1.65, Constants.kLeftSwitchCloseCorner.y() + Constants.kRobotHalfWidth + 5.2, Pathfinder.d2r(0))	
		};
		super.maxAccel = 8.0;
