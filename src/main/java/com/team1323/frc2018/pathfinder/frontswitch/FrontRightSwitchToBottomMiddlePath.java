...
public class FrontRightSwitchToBottomMiddlePath extends PathfinderPath{
	...
	public FrontRightSwitchToBottomMiddlePath(){
		super.points = new Waypoint[]{
				new Waypoint(Constants.kRightSwitchCloseCorner.x() - Constants.kRobotHalfLength - 1.05, Constants.kRightSwitchCloseCorner.y() - Constants.kRobotHalfWidth - 0.5, Pathfinder.d2r(-120)),
