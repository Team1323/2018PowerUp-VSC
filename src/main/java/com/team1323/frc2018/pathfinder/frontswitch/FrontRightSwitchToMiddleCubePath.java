...
public class FrontRightSwitchToMiddleCubePath extends PathfinderPath{
	...
	public FrontRightSwitchToMiddleCubePath(){
		super.points = new Waypoint[]{
				new Waypoint(Constants.kRightSwitchCloseCorner.x() - Constants.kRobotHalfLength - 1.48, Constants.kRightSwitchCloseCorner.y() - Constants.kRobotHalfWidth - 0.5, Pathfinder.d2r(180)),
				...
				new Waypoint(Constants.kRightSwitchCloseCorner.x() - (2*Constants.kCubeWidth) - 1.88, Constants.kRightSwitchCloseCorner.y() - Constants.kRobotHalfWidth - 4.6, Pathfinder.d2r(0))	
			};
		super.maxAccel = 8.0;
