...
public class MiddleCubeToFrontLeftSwitchPath extends PathfinderPath{
	...
	public MiddleCubeToFrontLeftSwitchPath(){
		super.points = new Waypoint[]{
			new Waypoint(Constants.kLeftSwitchCloseCorner.x() - (2*Constants.kCubeWidth) - 1.65, Constants.kLeftSwitchCloseCorner.y() + Constants.kRobotHalfWidth + 5.2, Pathfinder.d2r(-90)),
			...
			new Waypoint(Constants.kLeftSwitchCloseCorner.x() - Constants.kRobotHalfLength - 0.4, Constants.kLeftSwitchCloseCorner.y() + Constants.kRobotHalfWidth + 0.5, Pathfinder.d2r(0))
		};
		super.maxAccel = 9.0;
