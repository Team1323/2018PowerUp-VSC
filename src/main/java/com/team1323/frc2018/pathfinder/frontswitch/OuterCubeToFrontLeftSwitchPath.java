...
public class OuterCubeToFrontLeftSwitchPath extends PathfinderPath{
	...
	public OuterCubeToFrontLeftSwitchPath(){
		super.points = new Waypoint[]{
			...
			new Waypoint(Constants.kLeftSwitchCloseCorner.x() - Constants.kRobotHalfLength - 1.25, Constants.kLeftSwitchCloseCorner.y() + Constants.kRobotHalfWidth + 0.95, Pathfinder.d2r(0))
		};
		super.maxAccel = 8.0;
