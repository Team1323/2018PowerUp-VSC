...
public class FrontLeftSwitchPath extends PathfinderPath{
	...
	public FrontLeftSwitchPath(){
		super.points = new Waypoint[]{
			...
			new Waypoint(Constants.kLeftSwitchCloseCorner.x() - Constants.kRobotHalfLength - 2.0, Constants.kLeftSwitchCloseCorner.y() + Constants.kRobotHalfWidth + 0.75, Pathfinder.d2r(0)),
		};
		super.maxAccel = 5.0;
