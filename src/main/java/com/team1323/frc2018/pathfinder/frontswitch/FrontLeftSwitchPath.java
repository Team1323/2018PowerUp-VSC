...
public class FrontLeftSwitchPath extends PathfinderPath{
	...
	public FrontLeftSwitchPath(){
		super.points = new Waypoint[]{
			...
			new Waypoint(Constants.kLeftSwitchCloseCorner.x() - Constants.kRobotHalfLength - 1.85, Constants.kLeftSwitchCloseCorner.y() + Constants.kRobotHalfWidth + 0.92, Pathfinder.d2r(0)),
		};
		super.maxAccel = 5.0;
