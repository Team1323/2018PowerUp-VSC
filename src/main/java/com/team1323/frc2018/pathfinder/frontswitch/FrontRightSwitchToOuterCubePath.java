...
public class FrontRightSwitchToOuterCubePath extends PathfinderPath{
	...
	public FrontRightSwitchToOuterCubePath(){
		super.points = new Waypoint[]{
				new Waypoint(Constants.kRightSwitchCloseCorner.x() - Constants.kRobotHalfLength - 2.0, Constants.kRightSwitchCloseCorner.y() - Constants.kRobotHalfWidth - 0.85, Pathfinder.d2r(180)),
				...
				new Waypoint(Constants.kRightSwitchCloseCorner.x() - (3*Constants.kCubeWidth) - 2.35, Constants.kRightSwitchCloseCorner.y() - Constants.kRobotHalfWidth - 4.5, Pathfinder.d2r(0))
			};
			super.maxAccel = 5.0;
