...
public class FrontLeftSwitchToBottomMiddlePath extends PathfinderPath{
	...
	public FrontLeftSwitchToBottomMiddlePath(){
		super.points = new Waypoint[]{
			new Waypoint(Constants.kLeftSwitchCloseCorner.x() - Constants.kRobotHalfLength - 0.4, Constants.kLeftSwitchCloseCorner.y() + Constants.kRobotHalfWidth + 0.5, Pathfinder.d2r(150)),
