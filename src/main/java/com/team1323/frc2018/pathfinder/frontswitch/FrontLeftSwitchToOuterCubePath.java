...
public class FrontLeftSwitchToOuterCubePath extends PathfinderPath{
	...
	public FrontLeftSwitchToOuterCubePath(){
		super.points = new Waypoint[]{
			new Waypoint(Constants.kLeftSwitchCloseCorner.x() - Constants.kRobotHalfLength - 2.0, Constants.kLeftSwitchCloseCorner.y() + Constants.kRobotHalfWidth + 0.75, Pathfinder.d2r(180)),
			...
			new Waypoint(Constants.kLeftSwitchCloseCorner.x() - (3*Constants.kCubeWidth) - 2.15, Constants.kLeftSwitchCloseCorner.y() + Constants.kRobotHalfWidth + 5.1, Pathfinder.d2r(0))
		};
		super.maxAccel = 5.0;
