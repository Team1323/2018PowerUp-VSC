...
public class FrontLeftSwitchToOuterCubePath extends PathfinderPath{
	...
	public FrontLeftSwitchToOuterCubePath(){
		super.points = new Waypoint[]{
			new Waypoint(Constants.kLeftSwitchCloseCorner.x() - Constants.kRobotHalfLength - 1.85, Constants.kLeftSwitchCloseCorner.y() + Constants.kRobotHalfWidth + 0.92, Pathfinder.d2r(180)),
