...
public class AlternateRightCubeToRightScalePath extends PathfinderPath{
	...
	public AlternateRightCubeToRightScalePath(){
		super.points = new Waypoint[]{
			...
			new Waypoint(Constants.kRightSwitchFarCorner.x() + /*4.45*/2.45, Constants.kRightSwitchFarCorner.y() + Constants.kRobotHalfLength + 0.55 - 0.5, Pathfinder.d2r(30.0)),//3.5 1.75
			new Waypoint(Constants.kRightScaleCorner.x() - Constants.kRobotHalfLength - /*0.25*/2.5, Constants.kRightScaleCorner.y() + Constants.kRobotHalfWidth + 2.5 - 1.0, Pathfinder.d2r(0))
		};
		super.maxSpeed = 8.0;
		super.maxAccel = 6.0;
