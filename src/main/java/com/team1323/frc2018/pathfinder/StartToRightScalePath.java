...
public class StartToRightScalePath extends PathfinderPath{
	...
	public StartToRightScalePath(){
		super.points = new Waypoint[]{
			...
			new Waypoint(18.75, 8.0, Pathfinder.d2r(90)),//20.5
			new Waypoint(18.75, 21.0 - 2.0, Pathfinder.d2r(90)),
			new Waypoint(Constants.kRightScaleCorner.x() - Constants.kRobotHalfLength - /*1.35*/3.0, Constants.kRightScaleCorner.y() + Constants.kRobotHalfWidth + 2.5 - 1.0, Pathfinder.d2r(0))
		};
