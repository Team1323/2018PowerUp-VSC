...
public class SetTrajectoryAction extends RunOnceAction{
	...
	public SetTrajectoryAction(Trajectory<TimedState<Pose2dWithCurvature>> trajectory, double goalHeading, double rotationTime){
	...
	public synchronized void runOnce(){
		swerve.setTrajectory(new TrajectoryIterator<>(new TimedView<>(trajectory)), goalHeading, rotationTime);
	}
}
