...
public class LeftSwitchRightScaleMode extends AutoModeBase {
	...
	public LeftSwitchRightScaleMode(){
	...
	protected void routine() throws AutoModeEndedException {
		...
		runAction(new ResetPoseAction(new Pose2d(new Translation2d(Constants.kRightSwitchFarCorner.x() + 3.5, Constants.kRightSwitchFarCorner.y() + Constants.kRobotHalfLength - 0.75), Rotation2d.fromDegrees(Swerve.getInstance().getPose().getRotation().getUnboundedDegrees()))));
