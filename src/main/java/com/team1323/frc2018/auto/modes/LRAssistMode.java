...
public class LRAssistMode extends AutoModeBase{
	...
	protected void routine() throws AutoModeEndedException {
		...
		runAction(new SetTrajectoryAction(trajectories.frontLeftSwitch, -1.0, 1.0));
        ...
        runAction(new SetTrajectoryAction(trajectories.alternateMiddleCubeToRightScale, -95.0, 0.5));
        runAction(new WaitAction(0.5));
